...
1. **Dockerfile Rules (The "Anti-Casino" Policy)**:
    ...
    - **✅ REQUIRED**: Pin image by version; prefer digest pin when possible.
        - *Good*: `node:20.11-bullseye-slim@sha256:...`
        - *Good*: `python:3.11.9-slim-bullseye`
...
1. **VERSION PINNING**: You must choose a stable, recent version if none is specified (e.g., `Node 20`, `Python 3.11`, `Postgres 16`). NEVER leave it open; prefer digest pins in CI.
