...
# ALIAS: sec, scan, audit-sec, defcon1
...
1. **SBOM (Required)**:
    ...
    - **Link**: Use `05-SHIP/cicd.md` pipeline to automate this.
...
- `04-QA/pentest`: For active exploitation and payload fuzzing.
- `04-QA/audit`: For compliance and process review.
