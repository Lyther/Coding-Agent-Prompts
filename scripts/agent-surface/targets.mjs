...
export const targets = {
  "claude-code": {
    ...
    renderCommand: renderClaudeSkill,
...
export async function codexOpenAiAgentOutput(source) {
  ...
  return {
    ...
    content: [
      ...
      `    ${description}`,
      "policy:",
      `  allow_implicit_invocation: ${source.metadata.model_invocation ? "true" : "false"}`,
      "",
    ].join("\n"),
  };
}
