...
# ALIAS: ui, view, widget, page, screen
...
2. **Check Boundary (Crucial)**:
    - **Client-Side**: Fetch via API endpoints (`01-ARCH/api.md`). **NEVER** import DB drivers.
    - **Data Shapes**: Use types from `01-ARCH/model.md` (or equivalent shared types).
